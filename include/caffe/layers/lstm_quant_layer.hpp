#ifndef CAFFE_LSTM_QUANT_LAYER_HPP_
#define CAFFE_LSTM_QUANT_LAYER_HPP_
...
class LSTMQuantLayer : public RecurrentLayer<Dtype> {
 public:
  explicit LSTMQuantLayer(const LayerParameter& param)
...
/**
 * @brief A helper for LSTMQuantLayer: computes a single timestep of the
...
#endif  // CAFFE_LSTM_QUANT_LAYER_HPP_
