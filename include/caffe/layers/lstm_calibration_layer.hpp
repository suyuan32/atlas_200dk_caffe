...
class LSTMCalibrationLayer : public RecurrentLayer<Dtype> {
 public:
  explicit LSTMCalibrationLayer(const LayerParameter& param)
      : RecurrentLayer<Dtype>(param) {}

  virtual inline const char* type() const { return "LSTMCalibration"; }
...
/**
 * @brief A helper for LSTMCalibrationLayer: computes a single timestep of the
